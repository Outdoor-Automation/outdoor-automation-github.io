              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/design/">Case Studies</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/feeling-responsive/design/grid/">Pest Deterance</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/typography/typography/">Security</a></li>
        ...
        <nav class="row">
          ...
          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
              ...
              <li><a href="http://github.com/phlow" target="_blank" class="icon-github" title="Code and stuff"></a></li>
            
              <li><a href="http://www.youtube.com/Outdoor-Automation" target="_blank" class="icon-youtube" title="Videos from YouTube"></a></li>
