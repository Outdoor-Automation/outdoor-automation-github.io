...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive" class="icon-tree"> Outdoor Automation</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/">Outdoor Automation</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/design/">Case Studies</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/feeling-responsive/design/grid/">Goose Chasing</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/typography/typography/">Pipe inspection</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/page/">Crop Monitoring</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/post-left-sidebar/">Boat Inspection</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/post-right-sidebar/">Underwater mapping</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/page-fullwidth/">Search and Rescue</a></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/headers/">About Us</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="Outdoor Automation – Affordable, industrial grade autonomous solutions">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="Outdoor Automation – Affordable, industrial grade autonomous solutions">
			</a>
